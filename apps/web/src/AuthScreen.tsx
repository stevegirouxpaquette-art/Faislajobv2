...
export default function AuthScreen({onAuthenticated}:Props){
  ...
  return <main className="fj-home">
    <section className="fj-hero">
      <div className="fj-topbar"><div className="fj-brandmark">🔧</div><div className="fj-logo">FaisLa<span>Job</span></div><button className="fj-sector"><span>📍</span><span>Votre secteur<b>Trois-Rivières + 25 km</b></span><i>⌄</i></button></div>
      ...
      <div className="fj-hero-body">
        ...
        <div className="fj-mascot-card"><img src="/faislajob-mascot-clean.webp" alt="Mascotte FaisLaJob" className="fj-mascot-image"/><div className="fj-rest">On s’occupe<br/>du reste !</div></div>
      </div>
    </section>
    ...
    <section className="fj-services"><div className="fj-kicker">DES CENTAINES DE SERVICES</div><h2>On a la personne pour le faire.</h2><div className="fj-service-grid">{services.map(([icon,label])=><button key={label} onClick={()=>window.location.href='/request'}>{icon}<span>{label}</span></button>)}</div></section>
