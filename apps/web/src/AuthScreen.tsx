...
export default function AuthScreen({onAuthenticated}:Props){
  ...
  return <main className="fj-home">
    <section className="fj-hero">
      <div className="fj-topbar"><div className="fj-brandmark">🔧</div><div className="fj-logo">FaisLa<span>Job</span></div><div className="fj-sector">📍 <span>Votre secteur<b>Trois-Rivières + 25 km</b></span>⌄</div></div>
      ...
      <div className="fj-hero-body">
        ...
        <div className="fj-mascot-card"><div className="fj-city">▁▃▅▇▆▃▅▇</div><div className="fj-pin">◉</div><div className="fj-person">👨‍🔧</div><div className="fj-rest">On s’occupe<br/>du reste !</div></div>
      </div>
    </section>

    <button className="fj-request" onClick={()=>window.location.href='/request'}><div className="fj-phone">📱</div><span><small>NOUVELLE DEMANDE</small><strong>Dis-nous ce dont<br/>tu as <em>besoin</em></strong><b>On s’occupe du reste.</b></span><i>→</i></button>

    <section className="fj-services"><div className="fj-kicker">DES CENTAINES DE SERVICES</div><h2>On a la personne pour le faire.</h2><div className="fj-service-grid"><button onClick={()=>window.location.href='/request'}>🧹<span>Ménage</span></button><button onClick={()=>window.location.href='/request'}>🛠️<span>Petites réparations</span></button><button onClick={()=>window.location.href='/request'}>🌿<span>Extérieur & terrain</span></button><button onClick={()=>window.location.href='/request'}>🚚<span>Déménagement</span></button><button onClick={()=>window.location.href='/request'}>🐾<span>Animaux et plus</span></button></div></section>
